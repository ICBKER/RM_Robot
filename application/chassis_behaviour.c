...
//Ð¡ÍÓÂÝÒÆÖ²
static void chassis_gyro_control(fp32 *vx_set, fp32 *vy_set, fp32 *wz_set, chassis_move_t *chassis_move_rc_to_vector);
...
void chassis_behaviour_control_set(fp32 *vx_set, fp32 *vy_set, fp32 *angle_set, chassis_move_t *chassis_move_rc_to_vector)
{
    ...
    {
        chassis_gyro_control(vx_set, vy_set, angle_set, chassis_move_rc_to_vector);
    }
...
//Ð¡ÍÓÂÝÒÆÖ²º¯Êý
static void chassis_gyro_control(float *vx_set, float *vy_set, float *wz_set, chassis_move_t *chassis_move_rc_to_vector)
{
    if (vx_set == NULL || vy_set == NULL || wz_set == NULL || chassis_move_rc_to_vector == NULL)
    {
        return;
